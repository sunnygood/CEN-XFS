...
*
* File Name:   CENXFSPIN.h
* Description: Personal Identification Number Keypad(PIN) definitions   
*
* Author:      Liuguoxun
* Date:        2015-06-18        
*
...
#ifndef _CENXFSPIN_H_20150618
#define _CENXFSPIN_H_20150618
...
/* values of WFSPINIMPORTRSASIGNEDDESKEY.dwRSAEncipherAlgorithm and WFSPINCAPS.dwRSACryptAlgorithm */
/* 3.03/3.10/3.20/3.30 */
...
/* values of WFSPINGETCERTIFICATE.wGetCertificate and WFSPINCAPS.wCertificateTypes */
/* 3.03/3.10/3.20/3.30 */
